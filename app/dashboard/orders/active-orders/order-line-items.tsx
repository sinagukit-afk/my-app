...
export function resolveLineDiscount(row: OrderLineRow, discounts: DiscountOption[], modTotal = 0): number {
    ...
    <Card>
      ...
      <CardContent className="space-y-5">
        {rows.map((row, i) => {
          ...
          const zeroQtyWarning =
            !disabled && row.variantId && !(Number(row.quantity) > 0) ? "Won't be saved — enter a quantity" : undefined;
