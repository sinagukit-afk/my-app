...
export default function ItemAdjustmentPage() {
  return (
    <div>
      <PageHeader
      ...
      <Card className="max-w-lg">
        <CardHeader>
          ...
          <CardDescription>
            This page will let you create adjustment entries that increase or decrease stock
            quantities with an audit-trail reason code.
          </CardDescription>
        </CardHeader>
        <CardContent>
