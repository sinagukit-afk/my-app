...
**Before running any of these, follow the Preflight check in the `erp-supabase` skill** — confirm against the live app/DB that the phase's starting assumptions still hold, don't just trust this roadmap or `MODULE_STATUS.md`.
