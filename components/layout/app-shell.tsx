...
const NAV: NavEntry[] = [
  ...
  },
  {
    ...
    icon: LayersIcon,
    children: [
      { kind: "item", label: "Inventory", href: "/dashboard/inventory/monitoring", icon: LayersIcon, countKey: "inventoryAttention" },
      { kind: "item", label: "Item Adjustments", href: "/dashboard/inventory/adjustment", icon: LayersIcon },
    ...
    children: [
      {
        ...
        label: "Transactions",
        children: [
          { kind: "item", label: "Customer Payments", href: "/dashboard/finance/payments", icon: CurrencyIcon, countKey: "ordersPayment" },
          { kind: "item", label: "Supplier Payments", href: "/dashboard/finance/supplier-payments", icon: CurrencyIcon, countKey: "supplierPayment" },
          ...
          { kind: "item", label: "Credit Card Payable", href: "/dashboard/finance/credit-card-payable", icon: CurrencyIcon },
        ],
      },
      {
        kind: "subgroup",
    ...
    children: [
      ...
      { kind: "item", label: "Journal Entries", href: "/dashboard/accounting/journal", icon: LedgerIcon },
      {
        ...
        children: [
          ...
          { kind: "item", label: "Cash Flow", href: "/dashboard/accounting/cash-flow", icon: LedgerIcon },
        ],
      },
      {
        kind: "subgroup",
        ...
        children: [
          ...
          { kind: "item", label: "Product Accounts", href: "/dashboard/accounting/financial-settings/product-mapping", icon: LedgerIcon },
